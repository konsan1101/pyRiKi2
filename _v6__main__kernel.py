...
qPython_selfcheck        = '_v6_sub_self_check.py'
qPython_smartSpk         = '_v6_sub_smart_speaker.py'
qPython_rssSearch        = '_v6_sub_rss_search.py'
qPython_weather          = '_v6_sub_weather_search.py'
