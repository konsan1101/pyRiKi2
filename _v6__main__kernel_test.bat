...
SET api=
rem SET /P api="f=free,g=google,w=watson,m=azure,a=aws,n=nict,s=special："
...
SET dev=bluetooth
SET guide=on
rem SET /P mode="1=hud,2=live,3=translator,4=speech,5=number,6=camera,8=assistant,9=reception："
