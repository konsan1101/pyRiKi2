...
SET api=
SET /P api="f=free,g=google,w=watson,m=azure,a=aws,n=nict："
IF %api%@==@        SET api=free
...
ECHO;
ECHO -------------------------------
ECHO python _v5_speech__gijiroku1.py
...
ECHO;
ECHO ----------------------------------------------------------------------InpTrn
ECHO python _v5__main_speech.py speech file usb off 0 %apii% %apit% %apio% ja ja
...
ECHO;
ECHO -------------------------------
ECHO python _v5_speech__gijiroku2.py
